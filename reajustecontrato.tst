...
begin
  ...
  Loop
     ...
     where cp.slf_contrato_codigo = vContrato
      ...
      wservice.pkg_glb_email.SP_ENVIAEMAIL(P_ASSUNTO => 'REAJUSTE CONTRATO ' || vContrato || ' - ' || trim(rpad(i,3,'0')) || '/013' ,
                                           P_TEXTO   => null,
